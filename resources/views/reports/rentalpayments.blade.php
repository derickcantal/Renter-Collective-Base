<x-app-layout>
    ...
    <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            ...
            <u><a href="{{ route('reportrental.index') }}" class="inline-flex items-center text-lg font-high text-white-700 hover:text-blue-600 dark:text-white-400 dark:hover:text-white">Rental Payments</a></u> |
            <a href="{{ route('reportrequest.index') }}" class="inline-flex items-center text-lg font-high text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-gray">Requests</a>
